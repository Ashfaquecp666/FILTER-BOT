...
API_ID = int(environ.get('API_ID', '27774519'))
API_HASH = environ.get('API_HASH', 'b0859bfd2f249053adeb775a78454500')
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7615146175').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002591931306'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002664226726').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002260051281') # give your force subscribe channel id here else leave it blank
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-4944374368')
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002539090616').split()]  # For Multiple Id Use One Space Between Each.


# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://gaganabcd979:KPssSSNyz415cQ7G@cluster0.acxvk8h.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+oKPlmfe__Gs5Mjll')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+ihhJSaZPSwo1NzM9')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+EWHp5ukG5kpkYzU1') # Support Chat Link Without https:// or @
